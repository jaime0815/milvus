...
func checkGetPrimaryKey(coll *schemapb.CollectionSchema, idResult gjson.Result) string {
	primaryField := getPrimaryField(coll)
...
// field is only shown in output fields, not collection schema's fields, maybe dynamic field
